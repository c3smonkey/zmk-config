...
Big Thanks to [minusfive](https://github.com/minusfive/zmk-config)

Search own Icons for keymap at [pictogrammers](https://pictogrammers.com/library/mdi/icon/fit-to-screen-outline/)

Generate keymap with : 
```bash
./generateKeymap.sh 
```

the script will call the following command : 
```bash
